...
namespace MVCD2.Migrations
{
    ...
    [Migration("20250328101914_Update2StudentUserRelation")]
    partial class Update2StudentUserRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MVCD2.Models.Instructors", b =>
                {
                    ...
                    b.HasOne("MVCD2.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("MVCD2.Models.students", b =>
                {
                    ...
                    b.HasOne("MVCD2.Models.ApplicationUser", "User")
                        .WithOne("Student")
                        .HasForeignKey("MVCD2.Models.students", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
